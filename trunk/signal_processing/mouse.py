...
if __name__ == '__main__':
    ...
    bpWriter1 = csv.writer(open('bp-joao-h1.csv', 'wb'), delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
    bpWriter2 = csv.writer(open('bp-joao-h2.csv', 'wb'), delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
    while True:
