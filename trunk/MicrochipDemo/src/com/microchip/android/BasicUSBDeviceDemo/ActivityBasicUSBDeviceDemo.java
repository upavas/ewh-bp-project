    ...
    private Handler handler = new Handler() {
    	...
    	public void handleMessage(Message msg) {
			...
			if(msg.obj.getClass().equals(MessageButton.class)) {
				...
				updatePotentiometer(R.id.potentiometer_status, ((MessagePotentiometer)msg.obj).percentageChar);
...
//		tv.append(","+percentage);
    ...
    private void updatePotentiometer(int id, String percentageChar) {
		TextView tv;
		tv=(TextView)findViewById(R.id.textView1);
		tv.append(","+percentageChar);
    }
