...
public class SignalProcessing {
	...
	public BloodPressureValues signalProcessing(TimeSeriesMod aux5,
		...
		/**
		 * FILTER 1 remove zeros ('crazy jumps') from digital signal
		 */
		...
		// */
		// TimeSeriesMod aux5 = ConvertTommHg.convertTommHg(vals1,
		// samplingFrequency);

		/**
		 * GET CUFF DEFLATION get the decreasing part of the signal in the range
		 * 220 to 40 mm Hg
		 */
