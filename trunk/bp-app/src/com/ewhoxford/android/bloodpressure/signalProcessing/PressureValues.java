 ...
 * 
 * @author user
 * Determines systolic, diastolic and mean arterial blood pressure values
 */
public class PressureValues {
	 ...
	 * @see bloodPressure
	 */
	public BloodPressureValues pressureValues(TimeSeriesMod oscillations, TimeSeriesMod curve){
		...
		maxOscillationsInterp = LinearInterpolation.linearInterpolation(maxTimeMod, maxOscillationsMod, oscillations.time);
