...
// ************** OUR CODE ***********************************************************************************************************************
	...
	if (PIR1bits.ADIF == 1)	{		PIR1bits.ADIF = 0;                           
		...
		if(USBUSARTIsTxTrfReady())
		{
			...
			//copy over the data to the USB buffer
			USB_In_Buffer[0] = 0;
			USB_In_Buffer[1] = 0;
			USB_In_Buffer[2] = ADRESH;				//ADRESH+1;			//horizontal (X vector) displacement+1 to cover usb issues with values 0 and 256
...
void UserInit(void)
{
    ...
    buttonCount = 0;
    buttonPressed = FALSE;
    stringPrinted = TRUE;		//it was TRUE!!!
