	...
	ServiceListener<BackgroundUploader>, PatientLookupListener 
{
	...
	//TODO: to attach sana indicator to an intent
	protected static final int SANA_ACTIVITY =1;
	// Intent
	...
	protected void onNewIntent(Intent intent) {
		...
		try {
			...
			case PLUGIN_INTENT_REQUEST_CODE:
				...
				//TODO: intent to start the BP app
				plug.putExtra("callingApp", SANA_ACTIVITY);
